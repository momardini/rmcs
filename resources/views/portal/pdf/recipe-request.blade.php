...
<div id="page-border">
    ...
    <table style="width: 100%;" class="noborderdtable">
        ...
        <tr>
            <td colspan="3" style="text-align: center;">
                <h2><strong>{{ __('portal.patient.recipe') }}</strong></h2>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" style="text-align: left;"><span
                    style="font-size: xx-large;">R<sub>x</sub></span></td>
        </tr>
        </tbody>
    </table>
    <br>
    <table style="width: 99%; margin-left: auto; margin-right: auto;" class="borderdtable">
        ...
        <tr>
            ...
            <th style="width: 30%; text-align: center;"><strong>الدواء</strong></th>
            <th style="width: 15%; text-align: center;"><strong>الشكل</strong></th>
            <th style="width: 20%; text-align: center;"><strong>الجرعة</strong></th>
            <th style="width: 25%; text-align: center;"><strong>ملاحظة</strong></th>
            <td style="width: 5%; text-align: center;"> العدد</td>
        </tr>
        </thead>
        <tbody>
        @foreach ($interview->recipes as $recipe)
            <tr>
                <th style="width: 5%; text-align: center;font-size: x-small;font-weight: normal;">{{ \App\Models\Recipe::latin_number($loop->index + 1) }}</td>
                <th style="width: 30%; text-align: center;font-size: x-small;font-weight: normal;">{{$recipe->medicine_title}}</td>
                <th style="width: 15%; text-align: center;font-size: x-small;font-weight: normal;">{{$recipe->pharmaceutical_form->description}}</td>
                <th style="width: 20%; text-align: center;font-size: x-small;font-weight: normal;">{{$recipe->repeats->description}}</td>
                <th style="width: 25%; text-align: center;font-size: x-small;font-weight: normal;">{{$recipe->note}}</th>
                <td style="width: 5%; text-align: center;font-size: x-small;font-weight: normal;">{{$recipe->count}}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
